// Package piglatin provides a Go client for the Pig Latin API.
//
// For more information, visit: https://apiverve.com/marketplace/piglatin?utm_source=go&utm_medium=readme
package piglatin
...
// Request contains the parameters for the Pig Latin API.
//
// Parameters:
//   - text (required): string - The text to encode in Pig Latin
//   - exclusions: array - Words to exclude from encoding
type Request struct {
	Text string `json:"text"` // Required
	Exclusions []string `json:"exclusions,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the Pig Latin API.
type ResponseData struct {
	Text string `json:"text"`
	Exlcusions []string `json:"exlcusions"`
}
