...
```gradle
dependencies {
    implementation 'com.github.apiverve:piglatin-api:1.1.12'
}
```
...
```java
import com.apiverve.piglatin.PigLatinAPIClient;
import com.apiverve.piglatin.APIResponse;
import com.apiverve.piglatin.APIException;

// Initialize the client
PigLatinAPIClient client = new PigLatinAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/piglatin](https://docs.apiverve.com/ref/piglatin)
...
- **Documentation:** [https://docs.apiverve.com/ref/piglatin](https://docs.apiverve.com/ref/piglatin)
- **Issues:** [GitHub Issues](https://github.com/apiverve/piglatin-api/issues)
