...
class piglatinWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/piglatin');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/piglatin';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"text":{"type":"string","required":true},"exclusions":{"type":"array","required":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/piglatin`);
        }
    }
...
module.exports = piglatinWrapper;
